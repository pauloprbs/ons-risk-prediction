...
# ---------------------------------------------------
# MUDANÇA 1: O bloco de execução foi movido para esta função
# ---------------------------------------------------
def download_clima_main():
    """
    Função principal para orquestrar o download de dados de clima.
    """
...
# ---------------------------------------------------
# MUDANÇA 2: O bloco de execução agora chama a nova função
# ---------------------------------------------------
